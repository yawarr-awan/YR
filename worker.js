...
/** The user's journal - today's entry plus the recent ones before it.
 *
...
async function fetchJournal(env, email, day, limit) {
  const out = { today: null, earlier: [], error: null };
