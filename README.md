...
- **Prayer times** — a chip in the header and on the Prayers tab shows the window you're in and how long is left; tapping it opens the countdown and every window of the day with its colour and its start and end, along with your calculation method, madhab (Hanafi/Maliki/Shafi'i/Hanbali), your saved location and the per-prayer colours. The same row shape carries through to the Prayers checklist and the made-up (qada) card, and the calendar rings the window you're in.
