...
- **Calendar tab** — a full **week** view across all your Google calendars: seven days side by side on one hour grid, with the day you're looking at given four times the width so it stays readable, and every hour tinted by whichever prayer's time window it falls in. Swipe (or tap a day heading) to slide between days; the ‹ › buttons move between weeks.
